        ...
        ScrollView(.vertical){
            VStack(spacing:5){
                ...
                VStack{
                    ...
                    Text("For consumers who shop in bulk")
                ...
                ScrollView(.vertical){
                    // task one
                    HStack(spacing:50){
                        Image(uiImage: UIImage(named: "earth1.png")!)
                            .resizable()
                            .frame(width: 50, height: 50, alignment: .leading)
                        
                        VStack(alignment: .leading, spacing: 5){
                            Text("Average rating >= 3.0")
                    ...
                    // task two
                    HStack(spacing:50){
                        Image(uiImage: UIImage(named: "earth2.png")!)
                            .resizable()
                            .frame(width: 50, height: 50, alignment: .leading)
                    ...
                    // task three
                    HStack(spacing:50){
                        Image(uiImage: UIImage(named: "earth3.png")!)
                            .resizable()
                            .frame(width: 50, height: 50, alignment: .leading)
                    ...
                    // task four
                    HStack(spacing:50){
                        Image(uiImage: UIImage(named: "earth4.png")!)
                            .resizable()
                            .frame(width: 50, height: 50, alignment: .leading)
                    ...
                    // task five
                    HStack(spacing:50){
                        Image(uiImage: UIImage(named: "earth5.png")!)
                            .resizable()
                            .frame(width: 50, height: 50, alignment: .leading)
                    ...
                    // task six
                    HStack(spacing:50){
                        Image(uiImage: UIImage(named: "earth6.png")!)
                            .resizable()
                            .frame(width: 50, height: 50, alignment: .leading)
