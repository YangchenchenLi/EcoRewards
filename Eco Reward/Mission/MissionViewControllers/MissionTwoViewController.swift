//
//  MissionTwoViewController.swift
//  Eco Reward
//
...
class MissionTwoViewController: UIViewController {

    override func viewDidLoad() {
        super.viewDidLoad()
        
        super.viewDidLoad()
        self.navigationItem.title = "Level Two Mission"
        
        
        let swiftUIController = UIHostingController(rootView: MissionView2())
